...
# runs when APERTURE_MANAGE_TOOLCHAIN is ON (default for top-level builds).
...
#[[
    ...
    APERTURE_MANAGE_TOOLCHAIN is ON. clang-cl prefers llvm-lib or MSVC lib.exe;
...
function(aperture_configure_clang_archiver)
  if(NOT CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    return()
  endif()

  if(NOT APERTURE_MANAGE_TOOLCHAIN)
    message(STATUS "Clang archiver: leaving CMAKE_AR/CMAKE_RANLIB unchanged (APERTURE_MANAGE_TOOLCHAIN=OFF)")
    return()
  endif()
