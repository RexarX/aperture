...
/// behavior).
inline constexpr AssertionHandler DEFAULT_ASSERTION_HANDLER = nullptr;
...
/// @param condition The failed condition as a string
/// @param message Additional message* @param loc Source location of
/// the assertion
...
///   const auto formatted = aperture::FormatAssertionMessage(condition,
///                                                           message, loc);
///   mylib::log::Critical(formatted);
/// });
///
/// // Reset to default behavior
/// aperture::SetAssertionHandler(aperture::DEFAULT_ASSERTION_HANDLER);
/// @endcode
...
#define APERTURE_ASSERT(condition, ...)                       \
  do {                                                        \
    if constexpr (::aperture::details::ENABLE_ASSERT) {       \
